 ...
 */
public class QuotientByteNaturalBinaryOperation implements BinaryOperation<ByteNatural> {

    private final DivisionByteNaturalAlgorithm algorithm;

    public QuotientByteNaturalBinaryOperation(DivisionByteNaturalAlgorithm algorithm) {
