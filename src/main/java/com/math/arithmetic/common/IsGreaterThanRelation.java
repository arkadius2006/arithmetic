 ...
 */
public class IsGreaterThanRelation<T> implements Relation<T> { // todo instead of 3 classes create one "project" class
    private final BinaryRelation<T> binaryRelation;
    private final T value;

    public IsGreaterThanRelation(BinaryRelation<T> binaryRelation, T value) {
