 ...
 */
public class GreatestCommonDiviserBinaryOperation<T> implements BinaryOperation<T> {
    private final DivisionAlgorithm<T> algorithm;

    public GreatestCommonDiviserBinaryOperation(DivisionAlgorithm<T> algorithm) {
